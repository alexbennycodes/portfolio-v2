...
const NavLinks = ({ name, id }) => {
  return (
    <a className="font-serif ml-10 text-white ease-in duration-300 transition-all hover:text-themeColor capitalize cursor-pointer">
      <Link
        activeClass="active"
        className={id}
        to={id}
